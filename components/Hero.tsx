...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-[85vh] lg:min-h-[95vh] flex items-center justify-center pt-24 pb-16 lg:pt-28 lg:pb-24 overflow-visible"
    >
      {/* Background Radial Glow with subtle breathing aura */}
      <div
        aria-hidden="true"
        className="aura-pulse absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] md:w-[700px] md:h-[700px] lg:w-[850px] lg:h-[850px] rounded-full pointer-events-none z-[1]"
        style={{
          background:
      ...
      <div className="relative z-10 w-full">
        {/* =========================================
            DESKTOP VIEW (>= lg)
           ========================================= */}
        <div className="hidden lg:block relative h-[620px] w-full select-none">
          {/* Top-Right Micro-Copy */}
          <div
            className={`absolute right-0 top-6 text-right z-20 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${mounted ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-3"
              }`}
          >
          ...
          <div
            className={`absolute left-1/2 -translate-x-1/2 top-2 w-[440px] h-[550px] z-10 pointer-events-none transition-opacity duration-1000 ${mounted ? "opacity-100" : "opacity-0"
              }`}
          >
            <div
          ...
          <div
            className={`absolute left-0 top-24 z-20 transition-all duration-800 ease-[cubic-bezier(0.16,1,0.3,1)] ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
          >
          ...
          <div
            className={`absolute right-0 top-60 xl:top-68 z-20 text-right transition-all duration-800 delay-150 ease-[cubic-bezier(0.16,1,0.3,1)] ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
          >
          ...
          <div
            className={`absolute left-0 bottom-30 z-20 text-left transition-all duration-800 delay-250 ease-[cubic-bezier(0.16,1,0.3,1)] ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
              }`}
          >
        ...
        <div
          className={`flex flex-col justify-center items-center mx-auto gap-6 pt-6 pb-4 transition-all duration-800 delay-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
        >
          ...
          {/* Stat Badges with dynamic aura & hover micro-bounce */}
        ...
        {/* =========================================
           ...
           ========================================= */}
        <div
          className={`lg:hidden flex flex-col items-center text-center pt-4 pb-8 transition-all duration-800 ease-[cubic-bezier(0.16,1,0.3,1)] ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
        >
          {/* Top-Right Micro-Copy */}
          <div className="mb-6 inline-flex flex-col items-center text-xs font-mono text-[#B8A996]">
            <span className="text-[#F2E9DC] font-medium">Based in Nigeria</span>
            <span>Creative technology consultant</span>
          </div>

          {/* Portrait Container */}
          <div className="relative w-64 h-80 sm:w-72 sm:h-96 mb-6">
            <div
          ...
          <div className="space-y-2 mb-8">
            <h1 className="font-display font-bold text-4xl sm:text-5xl text-[#F2E9DC] tracking-tight leading-[1.05]">
              I build systems
            </h1>
            <p className="font-display font-bold text-4xl sm:text-5xl text-[#E8963C] tracking-tight leading-[1.05]">
              then make them make sense
            </p>
          </div>
          {/* Bottom Micro-Copy */}
          <div className="inline-block text-xs font-mono text-[#B8A996] leading-relaxed border-t border-[#F2E9DC]/10 pt-4 px-6">
