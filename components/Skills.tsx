...
export default function Skills() {
  ...
  return (
    <section id="skills" className="reveal-section py-20 md:py-24">
      ...
      <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
        {proficiencies.map((item, index) => (
          <article
            ...
            className="group relative min-h-64 overflow-hidden rounded-2xl border border-[#F2E9DC]/[0.08] bg-[#17141d]/45 p-5 transition-all duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1.5 hover:border-[#F2E9DC]/25 hover:bg-[#211d28]/70 hover:shadow-[0_16px_40px_rgba(0,0,0,0.25)]"
          >
